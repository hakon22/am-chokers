        ...
        items={[
          ...
          { key: 'reports', label: tMenu('menu.admin.reports.title'), children: <Collapse
            ...
            items={[
              ...
              { key: routes.reports.sales, label: <Button className="button-link text-start fs-6" href={routes.page.admin.salesReport} classNames={{ content: 'fw-300' }}>{tMenu('menu.admin.reports.sales')}</Button>, showArrow: false, collapsible: 'disabled' },
              { key: routes.reports.tryOn, label: <Button className="button-link text-start fs-6" href={routes.page.admin.tryOnReport} classNames={{ content: 'fw-300' }}>{tMenu('menu.admin.reports.tryOn')}</Button>, showArrow: false, collapsible: 'disabled' },
            ]}
          /> },
    ...
    isAdmin
      ? { key: 'admin', label: tMenu('menu.admin.title'), children: [
        ...
        { key: 'reports', label: tMenu('menu.admin.reports.title'), children: [
          ...
          { key: routes.reports.sales, label: <Link href={routes.page.admin.salesReport}>{tMenu('menu.admin.reports.sales')}</Link> },
          { key: routes.reports.tryOn, label: <Link href={routes.page.admin.tryOnReport}>{tMenu('menu.admin.reports.tryOn')}</Link> },
        ] },
