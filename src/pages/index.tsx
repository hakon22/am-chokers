...
const Index = () => {
  ...
  return (
    <div className="d-flex justify-content-center" onWheel={handleWheel}>
      ...
      <Link href={routes.catalog} title="Смотреть каталог" className="button border-button position-absolute" style={{ borderRadius: '6px', padding: '0.5rem 0.7rem' }}>Смотреть каталог</Link>
      {isLoaded && (
      <>
