const serverHost = process.env.NODE_ENV === 'production' && process.env.DB !== 'LOCAL' ? process.env.NEXT_PUBLIC_PRODUCTION_HOST : `${process.env.NEXT_PUBLIC_SERVER_HOST ?? 'http://192.168.1.61:'}${process.env.NEXT_PUBLIC_PORT ?? 3001}`;
