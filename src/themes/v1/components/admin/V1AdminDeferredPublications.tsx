...
export const V1AdminDeferredPublications = () => {
  ...
  return isAdmin ? (
    <>
      ...
      <h1 className="font-good-vibes-pro text-center mb-5" style={{ marginTop: '12%' }}>{t('titleWithCount', { count: deferredPublicationData.length + deferredPostData.length })}</h1>
