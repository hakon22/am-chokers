...
import { V2AdminTryOnAnalyticsView } from '@/themes/v2/components/admin/V2AdminTryOnAnalyticsView';
import { TryOnReportRegistry } from '@/components/admin/try-on-report/TryOnReportRegistry';
import styles from '@/themes/v2/components/admin/V2AdminTryOnReport.module.scss';

/**
 * Страница отчёта AI-примерки для темы V2
 * @returns JSX страницы с вкладками аналитики и реестра
 */
export const V2AdminTryOnReport = () => {
  ...
  const tabItems = [
    ...
    },
    {
      ...
      children: <V2AdminTryOnAnalyticsView reportState={analyticsState} lang={lang} />,
    },
  ];
