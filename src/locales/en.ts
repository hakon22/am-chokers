  ...
  translation: {
    pages: {
      ...
      delivery: {
        ...
        7: 'The Seller bears responsibility for the Goods’ safety during delivery until transfer to the Buyer.',
        8: 'Payment',
        ...
        10: 'We ship orders with 100% prepayment and provide a warranty of exchange or refund if the item does not fit for any reason — within 7 calendar days from the date of receipt of the order (provided it was not made to order and the item retains its appearance, with tags and packaging intact).',
      },
      jewelryCare: {
      ...
      offerAgreement: {
        ...
        15: '2.4.	Seller — the self-employed Kaledkin Alexey Leonidovich, INN 772481458341',
