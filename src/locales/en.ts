  ...
  translation: {
    pages: {
      ...
      itemList: {
        ...
        withoutTryOnFilter: 'Missing try-on photo',
      ...
      reports: {
        ...
        tryOn: {
          ...
          table: {
            ...
            generationDurationValue: '{{ seconds }} s',
            cost: 'Cost',
            result: 'Result',
          ...
          analytics: {
            ...
            filters: {
              period: 'Period',
              vtoType: 'Try-on type',
              vtoTypeAll: 'All types',
              ignorePeriod: 'Ignore period',
              attributionWindowDays: 'Attribution window, days',
              attributionWindowDaysValue: '{{ days }} days',
              attributionWindowDaysHint: 'How many days after a successful try-on a purchase of the same item by the logged-in user counts toward purchase conversion.',
            },
            loggedInOnlyDisclaimer: 'Purchase conversion is calculated for logged-in users only.',
            summary: {
              totalRequestsCount: 'Total requests',
              successfulTryOnsCount: 'Successful try-ons',
              successRate: 'Success rate',
              validationRejectedCount: 'Validation rejected',
              generationFailedCount: 'Generation errors',
              averageDurationMs: 'Average duration',
              totalAiCost: 'AI cost',
              averageSuccessCost: 'Avg. successful cost',
              ratingsCount: 'Ratings received',
              positiveRatingRate: 'Positive rating share',
            },
            conversion: {
              eligibleTryOnsCount: 'Try-ons (logged in)',
              convertedTryOnsCount: 'With purchase',
              tryOnToPurchaseRate: 'Purchase conversion',
              uniqueBuyersAfterTryOnCount: 'Unique buyers',
              attributedRevenue: 'Attributed revenue',
              attributedAiCost: 'AI cost (converted)',
              returnOnAiSpend: 'AI ROI',
              returnOnAiSpendHint: 'Attributed revenue divided by AI cost for converted try-ons. Shows how much revenue each unit of AI spend generated within the selected attribution window.',
            ...
            chart: {
              ...
              tryOnsCount: 'Requests',
              aiCost: 'AI cost, ₽',
              actionTotalTryOns: 'Requests',
              actionTotalAiCost: 'AI cost',
              statistics: {
                title: 'Chart statistics:',
                tryOns: 'Requests: {{ count }}',
                aiCost: 'AI cost: {{ value }} ₽',
              },
            },
            status: {
            ...
            table: {
              ...
              byVtoTypeTitle: 'By try-on type',
              byProviderTitle: 'By provider',
              rejectionsTitle: 'Validation rejections',
              conversionTitle: 'Conversion by product',
              item: 'Product',
              groupName: 'Group',
              provider: 'Provider',
              reason: 'Reason',
              ...
              averageDurationValue: '{{ seconds }} s',
              totalAiCost: 'AI cost',
              positiveRatingRate: 'Positive share',
              positiveRatingRateHint: 'Share of positive user ratings among all ratings for the product in the selected period and filters. Shown as dash when there are no ratings.',
              sharePercent: 'Share',
              sharePercentHint: 'Share of try-on requests of this type out of all requests for the selected period and filters.',
              count: 'Count',
              averageCost: 'Average cost',
              eligibleTryOnsCount: 'Try-ons (logged in)',
              convertedCount: 'Purchases',
              conversionRate: 'Conversion',
              attributedRevenue: 'Revenue',
              returnOnAiSpend: 'ROI',
              revenueValue: '{{ value }} ₽',
              percentValue: '{{ value }}%',
              ratingsShare: 'Ratings share',
              ratingsShareHint: 'Share of try-ons in the group that received a user rating, out of all try-ons in the group for the selected period and filters.',
            },
          },
        },
      },
    ...
    validation: {
      ...
      promotionalAlreadyUsed: 'Discount code has already been used',
      singleUseRequiresUsers: 'Single-use promo is only available for personal codes with assigned users',
