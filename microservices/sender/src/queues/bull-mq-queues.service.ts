...
import type { SmsCodeParameterInterface, SmsPasswordParameterInterface, SmsReceiptParameterInterface } from '@server/services/integration/sms.service';
...
export class BullMQQueuesService {
  ...
  private readonly queues: Record<BullMQQueuesEnum, Queue> = {
    ...
    [BullMQQueuesEnum.SMS_RECEIPT_QUEUE]: this.createQueue(BullMQQueuesEnum.SMS_RECEIPT_QUEUE),
    ...
    [BullMQQueuesEnum.NPD_NALOG_QUEUE]: this.createQueue(BullMQQueuesEnum.NPD_NALOG_QUEUE),
  };
  ...
  public sendSMSReceipt = (data: SmsReceiptParameterInterface) => this.queues[BullMQQueuesEnum.SMS_RECEIPT_QUEUE].add(BullMQQueuesEnum.SMS_RECEIPT_QUEUE, data);
  ...
  public NPDNalogCreateOrder = (data: NpdNalogOrderInterface) => this.queues[BullMQQueuesEnum.NPD_NALOG_QUEUE].add(BullMQQueuesEnum.NPD_NALOG_QUEUE, data);
}
